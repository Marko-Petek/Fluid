...
\fancyhead[R]{Maribor,\\ 20$^\text{th}$\ August\ 2019 \\[0.15cm] }
...
The whole purpose of a \textbsf{Block} is to provide a means to create nodes inside it by specifying two parameters on its edges: \textsf{tW} and \textsf{tH}.
