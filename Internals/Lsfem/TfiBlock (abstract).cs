...
namespace Fluid.Internals.Lsfem {
   ...
   public abstract class TfiBlock : Block {
      ...
      protected abstract Vec2 CalcUpperBoundaryPos(double ksi);
      ...
      protected abstract Vec2 CalcLowerBoundaryPos(double ksi);
      ...
      protected abstract Vec2 CalcLeftBoundaryPos(double eta);
      /// <summary>Returns real-world position of boundary node located at a given arc length coordinate.</summary><param name="eta">Arc length coordinate from 0 to 1.</param>
      protected abstract Vec2 CalcRightBoundaryPos(double eta);
      ...
      protected Vec2 CreatePosition(double ksi, double eta) {
