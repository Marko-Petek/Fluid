...
using static Fluid.Internals.Tensors.RefTnrFactory;
...
namespace Fluid.Internals.Tensors
{
   ...
   internal static bool CompareSubstrcβ<τ,α>(this RefTnr<τ,α> t1, RefTnr<τ,α> t2)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() =>
   ...
   public static RefTnr<τ,α>? SumInto<τ,α>(this RefTnr<τ,α>? t1, RefTnr<τ,α>? t2)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      if(t1 == null) {
         if(t2 == null)
            return null;
         else
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static RefTnr<τ,α>? SumIntoβ<τ,α>(this RefTnr<τ,α> t1, RefTnr<τ,α> t2)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      if(t2.Rank > 2) {
         ...
         foreach(var (i, st2) in t2) {
            ...
            if(t1.TryGetValue(i, out var st1)) {                        // Entry exists in t1, we must sum.
               ...
               sv2.CopyAsSubRefVecβ(t1, i); } } }                                // Entry does not exist in t1, copy as SubVec.
   ...
   public static RefTnr<τ,α>? SumTop<τ,α>(this RefTnr<τ,α>? t1, RefTnr<τ,α>? t2)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      if(t1 == null) {
         if(t2 == null)
            return null;
         else
   ...
   internal static RefTnr<τ,α>? SumTopβ<τ,α>(this RefTnr<τ,α> t1, RefTnr<τ,α> t2)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() =>
      t1.CopyAsTopRefTnrβ().SumIntoβ(t2);
   ...
   public static RefTnr<τ,α>? SubInto<τ,α>(this RefTnr<τ,α>? t1, RefTnr<τ,α>? t2)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      if(t1 == null) {
         if(t2 == null)
            return null;
         else
            return t2.CopyAsTopRefTnrβ().NegateIntoβ(); }
      else if(t2 == null)
         return t1;
   ...
   public static RefTnr<τ,α>? SubIntoβ<τ,α>(this RefTnr<τ,α> t1, RefTnr<τ,α> t2)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      if(t2.Rank > 2) {
         foreach(var (i, st2) in t2) {
            if(t1.TryGetValue(i, out var st1)) {                        // Equivalent subtensor exists in T1.
               ...
               st2.CopyAsSubRefTnrβ(t1, i).NegateIntoβ(); } }
      else if(t2.Rank == 2) {
         foreach(var (i, st2) in t2) {
            var sv2 = (RefVec<τ,α>) st2;
            if(t1.TryGetValue(i, out var st1)) {                        // Entry exists in t1, we must sum.
               ...
               sv2.CopyAsSubRefVecβ(t1, i).NegateIntoß(); } } }                                // Entry does not exist in t1, copy as subvector.
      else {                                                                     // We have a vector.
         var v1 = (RefVec<τ,α>) t1;
         var v2 = (RefVec<τ,α>) t2;
   ...
   public static RefTnr<τ,α>? SubTop<τ,α>(this RefTnr<τ,α>? t1, RefTnr<τ,α>? t2)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      if(t1 == null) {
         if(t2 == null)
            return null;
         else
   ...
   internal static RefTnr<τ,α>? SubTopβ<τ,α>(this RefTnr<τ,α> t1, RefTnr<τ,α> t2)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() =>
      t1.CopyAsTopRefTnrβ().SubIntoβ(t2);

   /// <summary>Modifies this tensor by negating each element.</summary>
   public static RefTnr<τ,α>? NegateInto<τ,α>(this RefTnr<τ,α>? t)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      if(t == null)
         return null;
      return t.NegateIntoβ();
   }

   internal static RefTnr<τ,α> NegateIntoβ<τ,α>(this RefTnr<τ,α> t)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      if(t.Rank > 2) {
   ...
   public static RefTnr<τ,α>? NegateTop<τ,α>(this RefTnr<τ,α>? t)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      if(t == null)
         return null;
      else
         return t.CopyAsTopRefTnrβ().NegateIntoβ();
   }

   internal static RefTnr<τ,α>? NegateTopβ<τ,α>(this RefTnr<τ,α> t)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() =>
      t.CopyAsTopRefTnrβ().NegateIntoβ();

   public static RefTnr<τ,α>? MulInto<τ,α>(this RefTnr<τ,α>? t, τ? scal)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      if(t == null || scal == null)
         return null;
      else
   ...
   internal static RefTnr<τ,α> MulIntoβ<τ,α>(this RefTnr<τ,α> t, τ scal)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
   ...
   public static RefTnr<τ,α>? MulTop<τ,α>(this RefTnr<τ,α>? t, τ? scal)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      if(t == null || scal == null)
         return null;
      else
   ...
   internal static RefTnr<τ,α> MulTopβ<τ,α>(this RefTnr<τ,α> t, τ scal)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() =>
      t.CopyAsTopRefTnrβ().MulIntoβ(scal);

   public static RefTnr<τ,α>? MulSub<τ,α>(this RefTnr<τ,α>? t, τ? scal, RefTnr<τ,α> sup, int inx)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      if(t == null || scal == null)
         return null;
      else
   ...
   /// <param name="scal"></param>
   /// <param name="vec"></param>
   internal static RefTnr<τ,α> MulSubβ<τ,α>(this RefTnr<τ,α> t, τ scal, RefTnr<τ,α> sup, int inx)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() =>
      t.CopyAsSubRefTnrβ(sup, inx).MulIntoβ(scal);


   
   /// <remarks> <see cref="TestRefs.TensorProduct"/> </remarks>
   public static RefTnr<τ,α> TnrProdTop<τ,α>(this RefTnr<τ,α> t1, RefTnr<τ,α> t2)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      ...
      RefTnr<τ,α> Recursion(RefTnr<τ,α> prod, RefTnr<τ,α> t1) {
         if(t1.Rank > 1) {                                       // Only reconstruction going on.
            foreach(var (i, st1) in t1) {
               var sProd = prod.SubRefTnrβ(i, st1.Count);         // Reconstructed st1 on prod. Creates vector appropriately
   ...
   this RefTnr<τ,α> t1, RefTnr<τ,α> t2, int slot1, int slot2)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
   ...
   int rankInx1, int rankInx2, List<int> strc, int conDim)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
   ...
   public static RefTnr<τ,α>? ContractTopβ<τ,α>(this RefTnr<τ,α> t1, RefTnr<τ,α> t2, int slotInx1, int slotInx2)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
   ...
   public static RefTnr<τ,α>? ContractTop<τ,α>(this RefTnr<τ,α>? t1, RefTnr<τ,α>? t2, int slotInx1, int slotInx2)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      if(t1 == null || t2 == null)
         return null;
      (List<int> strc, int rank1, int rank2, int conDim) = ContractTopPart1(t1, t2, slotInx1, slotInx2);
      return ContractTopPart2(t1, t2, rank1, rank2, strc, conDim);
   ...
   internal static RefTnr<τ,α>? SelfContractTop<τ,α>(this RefTnr<τ,α>? t, int slot1, int slot2)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      if(t == null)
         return null;
   ...
   internal static RefTnr<τ,α>? SelfContractTopβ<τ,α>(this RefTnr<τ,α> t, int slot1, int slot2)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      if(t.Rank > 3) {
   ...
   internal static RefVec<τ,α>? SelfContractR3Topβ<τ,α>(this RefTnr<τ,α> t, int slot1, int slot2)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
   ...
   internal static τ? SelfContractR2<τ,α>(this RefTnr<τ,α>? t)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      if(t == null)
         return NullA<τ,α>.O.Zero();
   ...
   internal static τ? SelfContractR2β<τ,α>(this RefTnr<τ,α> t)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      var substrc = t.Substrc;
      Assume.True(substrc[0] == substrc[1], () =>
         "Corresponding dimensions have to be equal.");
      τ? result = NullA<τ,α>.O.Zero();
      foreach(var (i, st) in t) {
         var sv = (RefVec<τ,α>) st;
         if(sv.Scals.TryGetValue(i, out τ? s))
            result = NullA<τ,α>.O.Sum(result, s); }
      return result;
   }
   ...
   static int ChangeRankNotation<τ,α>(int topRank, int slotOrRankInx)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() =>
   ...
   public static RefTnr<τ,α>? ReduceRankTop<τ,α>(this RefTnr<τ,α> t, int r, int e)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {                                    // FIXME: Method must properly reassign superiors.
   ...
   public static RefTnr<τ,α>? ReduceRankSub<τ,α>(this RefTnr<τ,α> t, int r, int e, RefTnr<τ,α> sup, int inx)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {                                    // FIXME: Method must properly reassign superiors.
      Assume.True(r < t.Rank && r > -1, () =>
         "You can only eliminate a rank in range [0, TopRank)." );
      var subStrc = t.Substrc;                                          // t can be a non-top tensor.
      var strcL = subStrc.Take(r);
      ...
      if(r == t.Rank - 1) {                                                           // Only one rank exists above rank r. Pick one tensor from rank r and return it.
         if(t.Rank > 1) {                                                             // Tensor to be reduced is at least rank two.
            if(t.TryGetValue(e, out var st))                                    // Element exists.
               return st.CopyAsSubRefTnrβ(sup, inx);
            else
               return null; }
         else                                                                       // Rank <= 1: impossible.
            throw new ArgumentException(
   ...
   public static RefVec<τ,α>? ElimR0onR2Top<τ,α>(this RefTnr<τ,α> t, int emtInx)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      Assume.True(t.Rank == 2, () =>
         "This method is intended for rank 2 tensors only.");
      return t.ElimR0onR2Topβ(emtInx);
   }

   internal static RefVec<τ,α>? ElimR0onR2Topβ<τ,α>(this RefTnr<τ,α> t, int emtInx)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
   ...
   public static RefVec<τ,α>? ElimR0onR2Sub<τ,α>(this RefTnr<τ,α> t, int elimInx, RefTnr<τ,α> sup, int inx)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      Assume.True(t.Rank == 2, () =>
         "This method is intended for rank 2 tensors only.");
   ...
   internal static RefVec<τ,α>? ElimR0onR2Subβ<τ,α>(this RefTnr<τ,α> t, int elimInx, RefTnr<τ,α> sup, int inx)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
   ...
   public static RefTnr<τ,α>? ElimR0onR3hTop<τ,α>(this RefTnr<τ,α> t, int elimInx)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      Assume.True(t.Rank > 2, () =>
         "This method is applicable to rank 3 and higher tensors.");
      return t.ElimR0onR3hTopβ(elimInx);
   }

   internal static RefTnr<τ,α>? ElimR0onR3hTopβ<τ,α>(this RefTnr<τ,α> t, int elimInx)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      var strc = t.Substrc.SkipLast(1).ToList();
   ...
   public static RefTnr<τ,α>? ElimR0onR3hSub<τ,α>(this RefTnr<τ,α> t, int elimInx, RefTnr<τ,α> sup, int inx)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      Assume.True(t.Rank > 2, () =>
   ...
   internal static RefTnr<τ,α>? ElimR0onR3hSubβ<τ,α>(this RefTnr<τ,α> t, int elimInx, RefTnr<τ,α> sup, int inx)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      var nt = sup.SubRefTnrβ<τ,α>(inx, t.Count);
      if(t.Rank > 3) {
         foreach(var (i,st) in t)
            st.ElimR0onR3hSubβ(elimInx, nt, i); }
      else {                                                                  // src.Rank == 3.
   ...
   public static RefTnr<τ,α>? ElimR1hOnR3hTop<τ,α>(this RefTnr<τ,α> t, int e, int r)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      Assume.True(t.Rank > 3, () =>
         "This method is applicable to rank 3 and higher tensors.");
      return t.ElimR1hOnR3hTopβ(e,r);
   }

   internal static RefTnr<τ,α>? ElimR1hOnR3hTopβ<τ,α>(this RefTnr<τ,α> t, int e, int r)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {      // Recursively copies tensors.
      var subStrc = t.Substrc;                                          // t can be a non-top tensor.
      var strcL = subStrc.Take(r);
      var strcR = subStrc.Skip(r + 1);
      var strc = strcL.Concat(strcR).ToList();
   ...
   public static RefTnr<τ,α>? ElimR1hOnR3hSub<τ,α>(this RefTnr<τ,α> t, int e, int r, RefTnr<τ,α> sup, int inx)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      Assume.True(t.Rank > 2, () =>
         "This method is intended for rank 3 tensors or higher.");
      var subStrc = t.Substrc;                                          // t can be a non-top tensor.
      var strcL = subStrc.Take(r);
   ...
   /// <param name="r"></param>
   internal static RefTnr<τ,α>? ElimR1hOnR3hSubβ<τ,α>(this RefTnr<τ,α> t, int e, int r, RefTnr<τ,α> sup, int inx)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {      // Recursively copies tensors.
      var nt = sup.SubRefTnrβ<τ,α>(inx, t.Count);
   ...
   /// <param name="t2">Tensor 2.</param>
   public static bool Equalsβ<τ,α>(this RefTnr<τ,α>? t1, RefTnr<τ,α>? t2)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
   ...
   public static bool Equalsβ<τ,α>(RefTnr<τ,α>? t1, RefTnr<τ,α>? t2, τ eps)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      if(t1 == null) {                                                            // If both are null, return true. If only one of them is null, return false.
         if(t2 == null)
            return true;
         else
