...
public static class ValTnrExt {
   ...
   internal static bool CompareSubstrcβ<τ,α>(this ValTnr<τ,α> t1, ValTnr<τ,α> t2)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() =>
   ...
   public static ValTnr<τ,α>? SumInto<τ,α>(this ValTnr<τ,α>? t1, ValTnr<τ,α>? t2)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t1 == null) {
         if(t2 == null)
            return null;
         else
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static ValTnr<τ,α>? SumIntoβ<τ,α>(this ValTnr<τ,α> t1, ValTnr<τ,α> t2)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t2.Rank > 2) {
   ...
   public static ValTnr<τ,α>? SumTop<τ,α>(this ValTnr<τ,α>? t1, ValTnr<τ,α>? t2)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t1 == null) {
         if(t2 == null)
            return null;
         else
   ...
   internal static ValTnr<τ,α>? SumTopβ<τ,α>(this ValTnr<τ,α> t1, ValTnr<τ,α> t2)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() =>
   ...
   public static ValTnr<τ,α>? SubInto<τ,α>(this ValTnr<τ,α>? t1, ValTnr<τ,α>? t2)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t1 == null) {
         if(t2 == null)
            return null;
         else
   ...
   public static ValTnr<τ,α>? SubIntoβ<τ,α>(this ValTnr<τ,α> t1, ValTnr<τ,α> t2)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t2.Rank > 2) {
         foreach(var (i, st2) in t2) {
            if(t1.TryGetValue(i, out var st1)) {                        // Equivalent subtensor exists in T1.
   ...
   public static ValTnr<τ,α>? SubTop<τ,α>(this ValTnr<τ,α>? t1, ValTnr<τ,α>? t2)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t1 == null) {
         if(t2 == null)
            return null;
         else
   ...
   internal static ValTnr<τ,α>? SubTopβ<τ,α>(this ValTnr<τ,α> t1, ValTnr<τ,α> t2)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() =>
      t1.CopyAsTopTnrβ().SubIntoβ(t2);

   /// <summary>Modifies this tensor by negating each element.</summary>
   public static ValTnr<τ,α>? NegateInto<τ,α>(this ValTnr<τ,α>? t)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t == null)
         return null;
      return t.NegateIntoβ();
   }

   internal static ValTnr<τ,α> NegateIntoβ<τ,α>(this ValTnr<τ,α> t)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t.Rank > 2) {
         foreach(var (i, st) in t)
            t.NegateIntoβ(); }
      else if(t.Rank == 2) {
         foreach(var i_st in t) {
            var sv = (ValVec<τ,α>) i_st.Value;
            sv.NegateIntoß(); } }
      else {
         var v = (ValVec<τ,α>) t;
         v.NegateIntoß(); }
   ...
   public static ValTnr<τ,α>? NegateTop<τ,α>(this ValTnr<τ,α>? t)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t == null)
         return null;
      else
   ...
   internal static ValTnr<τ,α>? NegateTopβ<τ,α>(this ValTnr<τ,α> t)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() =>
      t.CopyAsTopTnrβ().NegateIntoβ();

   public static ValTnr<τ,α>? MulInto<τ,α>(this ValTnr<τ,α>? t, τ scal)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t == null || scal.Equals(NonNullA<τ,α>.O.Zero()))
         return null;
      else
   ...
   internal static ValTnr<τ,α> MulIntoβ<τ,α>(this ValTnr<τ,α> t, τ scal)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   public static ValTnr<τ,α>? MulTop<τ,α>(this ValTnr<τ,α>? t, τ scal)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t == null || scal.Equals(NonNullA<τ,α>.O.Zero()))
         return null;
      else
   ...
   internal static ValTnr<τ,α> MulTopβ<τ,α>(this ValTnr<τ,α> t, τ scal)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() =>
      t.CopyAsTopTnrβ().MulIntoβ(scal);

   public static ValTnr<τ,α>? MulSub<τ,α>(this ValTnr<τ,α> t, τ scal, ValTnr<τ,α> sup, int inx)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t == null || scal.Equals(NonNullA<τ,α>.O.Zero()))
         return null;
      else
   ...
   /// <param name="scal"></param>
   /// <param name="vec"></param>
   internal static ValTnr<τ,α> MulSubβ<τ,α>(this ValTnr<τ,α> t, τ scal, ValTnr<τ,α> sup, int inx)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() =>
      t.CopyAsSubTnrβ(sup, inx).MulIntoβ(scal);


   
   /// <remarks> <see cref="TestRefs.TensorProduct"/> </remarks>
   public static ValTnr<τ,α> TnrProdTop<τ,α>(this ValTnr<τ,α> t1, ValTnr<τ,α> t2)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      ...
      ValTnr<τ,α> Recursion(ValTnr<τ,α> prod, ValTnr<τ,α> t1) {
   ...
   this ValTnr<τ,α> t1, ValTnr<τ,α> t2, int slot1, int slot2)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   internal static ValTnr<τ,α>? ContractTopPart2<τ,α>(this ValTnr<τ,α> t1, ValTnr<τ,α> t2,
   int rankInx1, int rankInx2, List<int> strc, int conDim)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      ...
      if(t1.Rank > 1) {
         if(t2.Rank > 1) {                                // First tensor is rank 2 or more.
            ...
            ValVec<τ,α> v2 = (ValVec<τ,α>) t2;
            if(t1.Rank == 2) {                                    // Result will be vector.
               ValVec<τ,α>? elimVec, sumand;
               var sum = TopVec<τ,α>(strc[0]);
               for(int i = 0; i < conDim; ++i) {
                  elimVec = (ValVec<τ,α>?) t1.ReduceRankTop(rankInx1, i);
   ...
   public static ValTnr<τ,α>? ContractTopβ<τ,α>(this ValTnr<τ,α> t1, ValTnr<τ,α> t2, int slotInx1, int slotInx2)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   public static ValTnr<τ,α>? ContractTop<τ,α>(this ValTnr<τ,α>? t1, ValTnr<τ,α>? t2, int slotInx1, int slotInx2)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t1 == null || t2 == null)
         return null;
      (List<int> strc, int rank1, int rank2, int conDim) = ContractTopPart1(t1, t2, slotInx1, slotInx2);
      return ContractTopPart2(t1, t2, rank1, rank2, strc, conDim);
   ...
   internal static ValTnr<τ,α>? SelfContractTop<τ,α>(this ValTnr<τ,α>? t, int slot1, int slot2)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t == null)
         return null;
   ...
   internal static ValTnr<τ,α>? SelfContractTopβ<τ,α>(this ValTnr<τ,α> t, int slot1, int slot2)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t.Rank > 3) {
   ...
   internal static ValVec<τ,α> SelfContractR3Topβ<τ,α>(this ValTnr<τ,α> t, int slot1, int slot2)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
            ...
            foreach(var (i, st) in t) {
               foreach(var (j, sst) in st) {
                  ...
                  if(ssv.Scals.TryGetValue(i, out τ s))
                     nv.Scals[j] = NonNullA<τ,α>.O.Sum(nv[j], s); } } } }
         ...
         foreach(var (i, st) in t) {
            foreach(var (j, sst) in st) {
               ...
               if(ssv.Scals.TryGetValue(j, out τ s))
                  nv.Scals[i] = NonNullA<τ,α>.O.Sum(nv[i], s); } } }
      return nv;
   }

   internal static τ SelfContractR2<τ,α>(this ValTnr<τ,α>? t)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t == null)
   ...
   internal static τ SelfContractR2β<τ,α>(this ValTnr<τ,α> t)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      var substrc = t.Substrc;
      Assume.True(substrc[0] == substrc[1], () =>
         "Corresponding dimensions have to be equal.");
      τ result = NonNullA<τ,α>.O.Zero();
      foreach(var (i, st) in t) {
         var sv = (ValVec<τ,α>) st;
         if(sv.Scals.TryGetValue(i, out τ s))
            result = NonNullA<τ,α>.O.Sum(result, s); }
      return result;
   }
   ...
   static int ChangeRankNotation<τ,α>(int topRank, int slotOrRankInx)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() =>
   ...
   public static ValTnr<τ,α>? ReduceRankTop<τ,α>(this ValTnr<τ,α> t, int r, int e)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {                                    // FIXME: Method must properly reassign superiors.
   ...
   public static ValTnr<τ,α>? ReduceRankSub<τ,α>(this ValTnr<τ,α> t, int r, int e, ValTnr<τ,α> sup, int inx)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {                                    // FIXME: Method must properly reassign superiors.
      Assume.True(r < t.Rank && r > -1, () =>
         "You can only eliminate a rank in range [0, TopRank)." );
      var subStrc = t.Substrc;                                          // t can be a non-top tensor.
      var strcL = subStrc.Take(r);
   ...
   public static ValVec<τ,α>? ElimR0onR2Top<τ,α>(this ValTnr<τ,α> t, int emtInx)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      Assume.True(t.Rank == 2, () =>
         "This method is intended for rank 2 tensors only.");
      return t.ElimR0onR2Topβ(emtInx);
   }

   internal static ValVec<τ,α>? ElimR0onR2Topβ<τ,α>(this ValTnr<τ,α> t, int emtInx)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   public static ValVec<τ,α>? ElimR0onR2Sub<τ,α>(this ValTnr<τ,α> t, int elimInx, ValTnr<τ,α> sup, int inx)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      Assume.True(t.Rank == 2, () =>
         "This method is intended for rank 2 tensors only.");
   ...
   internal static ValVec<τ,α>? ElimR0onR2Subβ<τ,α>(this ValTnr<τ,α> t, int elimInx, ValTnr<τ,α> sup, int inx)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   public static ValTnr<τ,α>? ElimR0onR3hTop<τ,α>(this ValTnr<τ,α> t, int elimInx)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      Assume.True(t.Rank > 2, () =>
         "This method is applicable to rank 3 and higher tensors.");
      return t.ElimR0onR3hTopβ(elimInx);
   }

   internal static ValTnr<τ,α>? ElimR0onR3hTopβ<τ,α>(this ValTnr<τ,α> t, int elimInx)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      var strc = t.Substrc.SkipLast(1).ToList();
   ...
   public static ValTnr<τ,α>? ElimR0onR3hSub<τ,α>(this ValTnr<τ,α> t, int elimInx, ValTnr<τ,α> sup, int inx)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      Assume.True(t.Rank > 2, () =>
   ...
   internal static ValTnr<τ,α>? ElimR0onR3hSubβ<τ,α>(this ValTnr<τ,α> t, int elimInx, ValTnr<τ,α> sup, int inx)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   public static ValTnr<τ,α>? ElimR1hOnR3hTop<τ,α>(this ValTnr<τ,α> t, int e, int r)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      Assume.True(t.Rank > 3, () =>
         "This method is applicable to rank 3 and higher tensors.");
      return t.ElimR1hOnR3hTopβ(e,r);
   }

   internal static ValTnr<τ,α>? ElimR1hOnR3hTopβ<τ,α>(this ValTnr<τ,α> t, int e, int r) where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {      // Recursively copies tensors.
      var subStrc = t.Substrc;                                          // t can be a non-top tensor.
      var strcL = subStrc.Take(r);
      var strcR = subStrc.Skip(r + 1);
      var strc = strcL.Concat(strcR).ToList();
   ...
   public static ValTnr<τ,α>? ElimR1hOnR3hSub<τ,α>(this ValTnr<τ,α> t, int e, int r, ValTnr<τ,α> sup, int inx)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      Assume.True(t.Rank > 2, () =>
         "This method is intended for rank 3 tensors or higher.");
      var subStrc = t.Substrc;                                          // t can be a non-top tensor.
      var strcL = subStrc.Take(r);
   ...
   /// <param name="r"></param>
   internal static ValTnr<τ,α>? ElimR1hOnR3hSubβ<τ,α>(this ValTnr<τ,α> t, int e, int r, ValTnr<τ,α> sup, int inx) where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {      // Recursively copies tensors.
      var nt = sup.SubTnrβ<τ,α>(inx, t.Count);
      if(t.Rank > r + 2) {                                    // We have not yet reached rank directly above rank scheduled for elimination: copy rank.
         foreach(var (i,st) in t)
            st.ElimR1hOnR3hSubβ(e, r, nt, i); }
   ...
   /// <param name="t2">Tensor 2.</param>
   public static bool Equalsβ<τ,α>(this ValTnr<τ,α>? t1, ValTnr<τ,α>? t2) where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      ...
      static bool TnrRecursion(ValTnr<τ,α> t1, ValTnr<τ,α> t2) {                       // Recursion must be entered with non-null tensors.
   ...
   public static bool Equalsβ<τ,α>(ValTnr<τ,α>? t1, ValTnr<τ,α>? t2, τ eps) where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t1 == null) {                                                            // If both are null, return true. If only one of them is null, return false.
         if(t2 == null)
            return true;
         else
      ...
      static bool TnrRecursion(ValTnr<τ,α> t1, ValTnr<τ,α> t2, τ eps) {                       // Recursion must be entered with non-null tensors.
         if(!t1.Keys.OrderBy(key => key).SequenceEqual(t2.Keys.OrderBy(key => key)))
            return false;                                                                    // Keys have to match. This is crucial.
         if(t1.Rank > 2) {
            foreach(var (i,st1) in t1) {
      ...
      static bool VecRecursion(ValTnr<τ,α> t1r2, ValTnr<τ,α> t2r2, τ eps) {
         if(!t1r2.Keys.OrderBy(key => key).SequenceEqual(t2r2.Keys.OrderBy(key => key)))
            return false;                                                                    // Keys have to match. This is crucial.
         foreach(var (i,st1) in t1r2) {
            var v1 = (ValVec<τ,α>) st1;
