...
public static class ValTnrFactory {
   ...
   public static ValVec<τ,α> TopVec<τ,α>(int dim, int cap = 6)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() =>
      new ValVec<τ,α>(dim, cap);
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static ValVec<τ,α> TopVec<τ,α>(ValVec<τ,α> v)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() =>
      new ValVec<τ,α>(v.Dim, v.Count);
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static ValVec<τ,α> SubVec<τ,α>(this ValTnr<τ,α>? sup, int inx, int cap = 6)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new()
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static ValVec<τ,α> SubVecβ<τ,α>(this ValTnr<τ,α> sup, int inx, int cap = 6)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      Assume.True(sup.Rank == 2, ()
         => "Vector's superior rank not 2. You can only create a subvec with a rank 2 superior.");
      var vec = new ValVec<τ,α>(sup, cap);
      sup[ValVec<τ,α>.V, inx] = vec;
      return vec;
   }
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static ValVec<τ,α>? TopVecFromSpan<τ,α>(Span<τ> span)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      var vec = new ValVec<τ,α>(span.Length, span.Length);
      for(int i = 0; i < span.Length; ++i) {
         if(!span[i].Equals(NonNullA<τ,α>.O.Zero()))
            vec.Add(i, span[i]); }
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static ValVec<τ,α>? SubVecFromSpan<τ,α>(Span<τ> span, ValTnr<τ,α> sup, int inx)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      Assume.True(sup.Rank == 2, () => "Vector's superior rank not 2. You can only create a subvector with a rank 2 superior.");
      var vec = new ValVec<τ,α>(sup, span.Length);
      for(int i = 0; i < span.Length; ++i) {
         if(!span[i].Equals(NonNullA<τ,α>.O.Zero()))
            vec.Add(i, span[i]); }
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static ValTnr<τ,α> TopTnr<τ,α>(List<int> strc, int cap = 6)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      Assume.True(strc.Count > 1, () =>
         "For creating tensors of rank 1 use Vector's constructor.");
      return new ValTnr<τ,α>(strc, cap);
   }
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static ValTnr<τ,α> SubTnr<τ,α>(this ValTnr<τ,α>? sup, int inx, int cap = 6)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new()
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static ValTnr<τ,α> SubTnrβ<τ,α>(this ValTnr<τ,α> sup, int inx, int cap = 6)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      Assume.True(sup.Rank > 1, ()
         => "Superior's rank too low. Cannot create a subtensor on a vector.");
      if(sup.Rank > 2) {
         var tnr = new ValTnr<τ,α>(sup, cap);
         sup[ValTnr<τ,α>.T, inx] = tnr;
         return tnr; }
      else
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static ValTnr<τ,α>? TopTnrFromSpan<τ,α>(Span<τ> span, params int[] strc)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      int rank = strc.Length;
      if(rank == 1)
         return TopVecFromSpan<τ,α>(span);
      else {
         var res = new ValTnr<τ,α>(strc.ToList(), strc[0]);                         // Empty tensor that enters recursion.
         Recursion(span, 0, res);
         return res.Count != 0 ? res : null; }

      void Recursion(Span<τ> spn, int slot, ValTnr<τ,α> tgt) {                      // Span and natural slot index to which it belongs.
         ...
         if(tgt.Rank > 2) {
            for(int i = 0; i < nIter; ++i) {                                        // Over each tensor. Create new spans and run recursion on them.
               ...
               var subTnr = new ValTnr<τ,α>(tgt, strc[slot]);
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static ValVec<τ,α>? CopyAsTopVec<τ,α>(this ValVec<τ,α>? v, int xCap = 0)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new()
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static ValVec<τ,α> CopyAsTopVecβ<τ,α>(this ValVec<τ,α> v, int xCap = 0)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static ValVec<τ,α>? CopyAsSubVec<τ,α>(this ValVec<τ,α>? v, ValTnr<τ,α> newSup,
   int inx, int xCap = 0)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() 
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static ValVec<τ,α> CopyAsSubVecβ<τ,α>(this ValVec<τ,α> v, ValTnr<τ,α> newSup,
   int inx, int xCap = 0)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static ValTnr<τ,α>? CopyAsTopTnr<τ,α>(this ValTnr<τ,α>? t, int xCap = 0)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new()
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static ValTnr<τ,α> CopyAsTopTnrβ<τ,α>(this ValTnr<τ,α> t, int xCap = 0)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t is ValVec<τ,α> v)
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static ValTnr<τ,α>? CopyAsSubTnr<τ,α>(this ValTnr<τ,α>? t, ValTnr<τ,α> newSup,
   int inx, int xCap = 0)  where τ : struct, IEquatable<τ>, IComparable<τ> where α : IAlgebra<τ>, new()
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static ValTnr<τ,α> CopyAsSubTnrβ<τ,α>(this ValTnr<τ,α> t, ValTnr<τ,α> newSup,
   int inx, int xCap = 0)  where τ : struct, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
