...
public static class RefTnrFactory {
   ...
   public static RefVec<τ,α> TopRefVec<τ,α>(int dim, int cap = 6)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() =>
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static RefVec<τ,α> TopRefVec<τ,α>(RefVec<τ,α> v)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() =>
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static RefVec<τ,α> SubRefVec<τ,α>(this RefTnr<τ,α>? sup, int inx, int cap = 6)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new()
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static RefVec<τ,α> SubRefVecβ<τ,α>(this RefTnr<τ,α> sup, int inx, int cap = 6)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static RefVec<τ,α>? TopRefVecFromSpan<τ,α>(Span<τ> span)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
      var vec = new RefVec<τ,α>(span.Length, span.Length);
      for(int i = 0; i < span.Length; ++i) {
         if(!span[i].Equals(NullA<τ,α>.O.Zero()))
            vec.Add(i, span[i]); }
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static RefVec<τ,α>? SubRefVecFromSpan<τ,α>(Span<τ> span, RefTnr<τ,α> sup, int inx)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static RefTnr<τ,α> TopRefTnr<τ,α>(List<int> strc, int cap = 6)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static RefTnr<τ,α> SubRefTnr<τ,α>(this RefTnr<τ,α>? sup, int inx, int cap = 6)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new()
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static RefTnr<τ,α> SubRefTnrβ<τ,α>(this RefTnr<τ,α> sup, int inx, int cap = 6)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static RefTnr<τ,α>? TopRefTnrFromSpan<τ,α>(Span<τ> span, params int[] strc)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static RefVec<τ,α>? CopyAsTopRefVec<τ,α>(this RefVec<τ,α>? v, int extraCap = 0)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() =>
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static RefVec<τ,α> CopyAsTopRefVecβ<τ,α>(this RefVec<τ,α> src, int extraCap = 0)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
   ...
   int inx, int xCap = 0)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new()
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static RefTnr<τ,α>? CopyAsTopRefTnr<τ,α>(this RefTnr<τ,α>? t, int xCap = 0)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new()
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static RefTnr<τ,α> CopyAsTopRefTnrβ<τ,α>(this RefTnr<τ,α> t, int xCap = 0)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
   ...
   RefTnr<τ,α> newSup, int inx, int xCap = 0)  where τ : class, IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ?>, new() {
