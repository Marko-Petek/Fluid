...
public static class TnrExt {
   ...
   internal static bool CompareSubstrcβ<τ,α>(this Tnr<τ,α> t1, Tnr<τ,α> t2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() =>
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static Tnr<τ,α>? SumIntoβ<τ,α>(this Tnr<τ,α> t1, Tnr<τ,α> t2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      if(t2.Rank > 2) {
   ...
   public static Tnr<τ,α>? SumTop<τ,α>(this Tnr<τ,α>? t1, Tnr<τ,α>? t2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      if(t1 == null) {
         if(t2 == null)
            return null;
         else
   ...
   internal static Tnr<τ,α>? SumTopβ<τ,α>(this Tnr<τ,α> t1, Tnr<τ,α> t2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() =>
   ...
   public static Tnr<τ,α>? SubIntoβ<τ,α>(this Tnr<τ,α> t1, Tnr<τ,α> t2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      if(t2.Rank > 2) {
         foreach(var (i, st2) in t2) {
            if(t1.TryGetValue(i, out var st1)) {                        // Equivalent subtensor exists in T1.
   ...
   public static Tnr<τ,α>? SubTop<τ,α>(this Tnr<τ,α>? t1, Tnr<τ,α>? t2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      if(t1 == null) {
         if(t2 == null)
            return null;
         else
   ...
   internal static Tnr<τ,α>? SubTopβ<τ,α>(this Tnr<τ,α> t1, Tnr<τ,α> t2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() =>
   ...
   internal static Tnr<τ,α> NegateIntoβ<τ,α>(this Tnr<τ,α> t)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      if(t.Rank > 2) {
   ...
   public static Tnr<τ,α>? NegateTop<τ,α>(this Tnr<τ,α>? t)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      if(t == null)
         return null;
      else
   ...
   internal static Tnr<τ,α>? NegateTopβ<τ,α>(this Tnr<τ,α> t)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() =>
   ...
   public static Tnr<τ,α>? MulTop<τ,α>(this Tnr<τ,α>? t, τ scal)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      if(t == null || scal.Equals(NonNullable<τ,α>.O.Zero()))
         return null;
      else
   ...
   internal static Tnr<τ,α> MulTopβ<τ,α>(this Tnr<τ,α> t, τ scal)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() =>
   ...
   /// <param name="scal"></param>
   /// <param name="vec"></param>
   internal static Tnr<τ,α> MulSubβ<τ,α>(this Tnr<τ,α> t, τ scal, Tnr<τ,α> sup, int inx)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() =>
   ...
   this Tnr<τ,α> t1, Tnr<τ,α> t2, int slot1, int slot2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
   ...
   int rankInx1, int rankInx2, List<int> strc, int conDim)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
   ...
   public static Tnr<τ,α>? ContractTop<τ,α>(this Tnr<τ,α>? t1, Tnr<τ,α>? t2, int slotInx1, int slotInx2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      if(t1 == null || t2 == null)
         return null;
      (List<int> strc, int rank1, int rank2, int conDim) = ContractTopPart1(t1, t2, slotInx1, slotInx2);
      return ContractTopPart2(t1, t2, rank1, rank2, strc, conDim);
   ...
   internal static Tnr<τ,α>? SelfContractTop<τ,α>(this Tnr<τ,α>? t, int slot1, int slot2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      if(t == null)
         return null;
   ...
   internal static Vec<τ,α> SelfContractR3Topβ<τ,α>(this Tnr<τ,α> t, int slot1, int slot2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
   ...
   internal static τ SelfContractR2<τ,α>(this Tnr<τ,α>? t)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      if(t == null)
   ...
   public static Tnr<τ,α>? ReduceRankSub<τ,α>(this Tnr<τ,α> t, int r, int e, Tnr<τ,α> sup, int inx)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {                                    // FIXME: Method must properly reassign superiors.
      Assume.True(r < t.Rank && r > -1, () =>
         "You can only eliminate a rank in range [0, TopRank)." );
      var subStrc = t.Substrc;                                          // t can be a non-top tensor.
      var strcL = subStrc.Take(r);
   ...
   public static Vec<τ,α>? ElimR0onR2Top<τ,α>(this Tnr<τ,α> t, int emtInx)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      Assume.True(t.Rank == 2, () =>
         "This method is intended for rank 2 tensors only.");
      return t.ElimR0onR2Topβ(emtInx);
   }

   internal static Vec<τ,α>? ElimR0onR2Topβ<τ,α>(this Tnr<τ,α> t, int emtInx)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
   ...
   public static Vec<τ,α>? ElimR0onR2Sub<τ,α>(this Tnr<τ,α> t, int elimInx, Tnr<τ,α> sup, int inx)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      Assume.True(t.Rank == 2, () =>
         "This method is intended for rank 2 tensors only.");
   ...
   internal static Vec<τ,α>? ElimR0onR2Subβ<τ,α>(this Tnr<τ,α> t, int elimInx, Tnr<τ,α> sup, int inx)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
   ...
   public static Tnr<τ,α>? ElimR0onR3hTop<τ,α>(this Tnr<τ,α> t, int elimInx)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      Assume.True(t.Rank > 2, () =>
         "This method is applicable to rank 3 and higher tensors.");
      return t.ElimR0onR3hTopβ(elimInx);
   }

   internal static Tnr<τ,α>? ElimR0onR3hTopβ<τ,α>(this Tnr<τ,α> t, int elimInx)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      var strc = t.Substrc.SkipLast(1).ToList();
   ...
   public static Tnr<τ,α>? ElimR0onR3hSub<τ,α>(this Tnr<τ,α> t, int elimInx, Tnr<τ,α> sup, int inx)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      Assume.True(t.Rank > 2, () =>
   ...
   internal static Tnr<τ,α>? ElimR0onR3hSubβ<τ,α>(this Tnr<τ,α> t, int elimInx, Tnr<τ,α> sup, int inx)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
   ...
   public static Tnr<τ,α>? ElimR1hOnR3hTop<τ,α>(this Tnr<τ,α> t, int e, int r)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      Assume.True(t.Rank > 3, () =>
         "This method is applicable to rank 3 and higher tensors.");
      return t.ElimR1hOnR3hTopβ(e,r);
   }

   internal static Tnr<τ,α>? ElimR1hOnR3hTopβ<τ,α>(this Tnr<τ,α> t, int e, int r) where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {      // Recursively copies tensors.
      var subStrc = t.Substrc;                                          // t can be a non-top tensor.
      var strcL = subStrc.Take(r);
      var strcR = subStrc.Skip(r + 1);
      var strc = strcL.Concat(strcR).ToList();
   ...
   public static Tnr<τ,α>? ElimR1hOnR3hSub<τ,α>(this Tnr<τ,α> t, int e, int r, Tnr<τ,α> sup, int inx)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      Assume.True(t.Rank > 2, () =>
         "This method is intended for rank 3 tensors or higher.");
      var subStrc = t.Substrc;                                          // t can be a non-top tensor.
      var strcL = subStrc.Take(r);
   ...
   /// <param name="r"></param>
   internal static Tnr<τ,α>? ElimR1hOnR3hSubβ<τ,α>(this Tnr<τ,α> t, int e, int r, Tnr<τ,α> sup, int inx) where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {      // Recursively copies tensors.
      var nt = sup.SubTnrβ<τ,α>(inx, t.Count);
      if(t.Rank > r + 2) {                                    // We have not yet reached rank directly above rank scheduled for elimination: copy rank.
         foreach(var (i,st) in t)
            st.ElimR1hOnR3hSubβ(e, r, nt, i); }
   ...
   /// <param name="t2">Tensor 2.</param>
   public static bool Equalsβ<τ,α>(this Tnr<τ,α>? t1, Tnr<τ,α>? t2) where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
   ...
   public static bool Equalsβ<τ,α>(Tnr<τ,α>? t1, Tnr<τ,α>? t2, τ eps) where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      if(t1 == null) {                                                            // If both are null, return true. If only one of them is null, return false.
         if(t2 == null)
            return true;
         else
