...
public static class TnrExt {
   ...
   internal static bool CompareSubstrcß<τ,α>(this Tnr<τ,α> t1, Tnr<τ,α> t2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() =>
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static Tnr<τ,α>? SumIntoß<τ,α>(this Tnr<τ,α> t1, Tnr<τ,α> t2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      if(t2.Rank > 2) {
   ...
   public static Tnr<τ,α>? SubIntoß<τ,α>(this Tnr<τ,α> t1, Tnr<τ,α> t2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      if(t2.Rank > 2) {
         foreach(var (i, st2) in t2) {
            if(t1.TryGetValue(i, out var st1)) {                        // Equivalent subtensor exists in T1.
   ...
   internal static Tnr<τ,α> NegateIntoß<τ,α>(this Tnr<τ,α> t)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      if(t.Rank > 2) {
   ...
   internal static Tnr<τ,α> MulIntoß<τ,α>(this Tnr<τ,α> t, τ scal)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
   ...
   /// <param name="scal"></param>
   /// <param name="vec"></param>
   internal static Tnr<τ,α> MulSubß<τ,α>(this Tnr<τ,α> t, τ scal, Tnr<τ,α> sup, int inx)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() =>
      ...
      Tnr<τ,α> Recursion(Tnr<τ,α> prod, Tnr<τ,α> t1) {
         if(t1.Rank > 1) {                                       // Only reconstruction going on.
            foreach(var (i, st1) in t1) {
               var sProd = prod.SubTnrß(i, st1.Count);         // Reconstructed st1 on prod. Creates vector appropriately
   ...
   public static Tnr<τ,α>? ContractTopß<τ,α>(this Tnr<τ,α> t1, Tnr<τ,α> t2, int slotInx1, int slotInx2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
   ...
   internal static Tnr<τ,α>? SelfContractTopß<τ,α>(this Tnr<τ,α> t, int slot1, int slot2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      if(t.Rank > 3) {
   ...
   internal static Vec<τ,α> SelfContractR3Topß<τ,α>(this Tnr<τ,α> t, int slot1, int slot2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
   ...
   internal static τ SelfContractR2ß<τ,α>(this Tnr<τ,α> t)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      var substrc = t.Substrc;
   ...
   internal static Tnr<τ,α>? ElimR0onR3hTopß<τ,α>(this Tnr<τ,α> t, int elimInx)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      var strc = t.Substrc.SkipLast(1).ToList();
      var nt = TopTensor<τ,α>(strc);
      if(t.Rank > 3) {
         foreach(var (i,st) in t) {
   ...
   internal static Tnr<τ,α>? ElimR0onR3hSubß<τ,α>(this Tnr<τ,α> t, int elimInx, Tnr<τ,α> sup, int inx)  where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {
      var nt = sup.SubTnrß<τ,α>(inx, t.Count);
      if(t.Rank > 3) {
         foreach(var (i,st) in t)
            st.ElimR0onR3hSubß(elimInx, nt, i); }
      else {                                                                  // src.Rank == 3.
   ...
   internal static Tnr<τ,α>? ElimR1hOnR3hTopß<τ,α>(this Tnr<τ,α> t, int e, int r) where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {      // Recursively copies tensors.
      var subStrc = t.Substrc;                                          // t can be a non-top tensor.
      var strcL = subStrc.Take(r);
      var strcR = subStrc.Skip(r + 1);
      var strc = strcL.Concat(strcR).ToList();
   ...
   /// <param name="r"></param>
   internal static Tnr<τ,α>? ElimR1hOnR3hSubß<τ,α>(this Tnr<τ,α> t, int e, int r, Tnr<τ,α> sup, int inx) where τ : IEquatable<τ>, IComparable<τ>  where α : IArithmetic<τ>, new() {      // Recursively copies tensors.
      var nt = sup.SubTnrß<τ,α>(inx, t.Count);
