...
public static class TnrFactory {
   ...
   public static Vec<τ,α> TopVec<τ,α>(int dim, int cap = 6)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() =>
      new Vec<τ,α>(dim, cap);
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static Vec<τ,α> TopVec<τ,α>(Vec<τ,α> v)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() =>
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static Vec<τ,α> SubVec<τ,α>(this Tnr<τ,α>? sup, int inx, int cap = 6)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new()
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static Vec<τ,α> SubVecβ<τ,α>(this Tnr<τ,α> sup, int inx, int cap = 6)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static Vec<τ,α>? TopVecFromSpan<τ,α>(Span<τ> span)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static Vec<τ,α>? SubVecFromSpan<τ,α>(Span<τ> span, Tnr<τ,α> sup, int inx)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static Tnr<τ,α> TopTnr<τ,α>(List<int> strc, int cap = 6)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static Tnr<τ,α> SubTnr<τ,α>(this Tnr<τ,α>? sup, int inx, int cap = 6)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new()
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static Tnr<τ,α> SubTnrβ<τ,α>(this Tnr<τ,α> sup, int inx, int cap = 6)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static Tnr<τ,α>? TopTnrFromSpan<τ,α>(Span<τ> span, params int[] strc)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static Vec<τ,α>? CopyAsTopVec<τ,α>(this Vec<τ,α>? v, int xCap = 0)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new()
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static Vec<τ,α> CopyAsTopVecβ<τ,α>(this Vec<τ,α> v, int xCap = 0)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   int inx, int xCap = 0)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() 
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   public static Tnr<τ,α>? CopyAsTopTnr<τ,α>(this Tnr<τ,α>? t, int xCap = 0)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new()
   ...
   /// <typeparam name="τ">Numeric type.</typeparam>
   /// <typeparam name="α">Arithmetic type.</typeparam>
   internal static Tnr<τ,α> CopyAsTopTnrβ<τ,α>(this Tnr<τ,α> t, int xCap = 0)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t is Vec<τ,α> v)
