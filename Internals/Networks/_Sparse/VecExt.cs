...
public static class VecExt {
   ...
   public static Vec<τ,α>? SumInto<τ,α>(this Vec<τ,α>? vec1, Vec<τ,α>? vec2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(vec2 == null)
         return vec1;
      if(vec1 == null)
   ...
   /// <param name="vec2">Sumand 2. Is not destroyed.</param>
   /// <remarks><see cref="TestRefs.VectorSum"/></remarks>
   internal static Vec<τ,α>? SumIntoß<τ,α>(this Vec<τ,α> vec1, Vec<τ,α> vec2)  where τ : IEquatable<τ>, IComparable<τ>   where α : IAlgebra<τ>, new() {
   ...
   public static Vec<τ,α>? SubInto<τ,α>(this Vec<τ,α>? vec1, Vec<τ,α>? vec2)  where τ : IEquatable<τ>, IComparable<τ>   where α : IAlgebra<τ>, new() {
      if(vec2 == null)
         return vec1;
      if(vec1 == null)
   ...
   /// <remarks><see cref="TestRefs.VectorSub"/></remarks>
   internal static Vec<τ,α>? SubIntoß<τ,α>(this Vec<τ,α> v1, Vec<τ,α> v2)  where τ : IEquatable<τ>, IComparable<τ>   where α : IAlgebra<τ>, new() {
   ...
   public static Vec<τ,α>? SumTop<τ,α>(this Vec<τ,α>? vec1, Vec<τ,α>? vec2)  where τ : IEquatable<τ>, IComparable<τ>   where α : IAlgebra<τ>, new() {
      if(vec1 == null) {
         if(vec2 == null)
            return null;
         else {
   ...
   internal static Vec<τ,α>? SumTopß<τ,α>(this Vec<τ,α> vec1, Vec<τ,α> vec2)  where τ : IEquatable<τ>, IComparable<τ>   where α : IAlgebra<τ>, new() =>
      TopVec<τ,α>(vec1).SumIntoß(vec1)!.SumIntoß(vec2);

   public static Vec<τ,α>? SubTop<τ,α>(this Vec<τ,α>? v1, Vec<τ,α>? v2)  where τ : IEquatable<τ>, IComparable<τ>   where α : IAlgebra<τ>, new() {
      if(v1 == null) {
         if(v2 == null)
            return null;
         else
   ...
   internal static Vec<τ,α>? SubTopß<τ,α>(this Vec<τ,α> v1, Vec<τ,α> v2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() =>
      TopVec<τ,α>(v1).SumIntoß(v1)!.SubIntoß(v2);
   
   /// <summary>Modifies this vector by negating each element.</summary>
   public static Vec<τ,α>? NegateInto<τ,α>(this Vec<τ,α>? vec)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(vec == null)
         return null;
      return NegateIntoß(vec);
   }
   internal static Vec<τ,α> NegateIntoß<τ,α>(this Vec<τ,α> vec)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   public static Vec<τ,α>? Negate<τ,α>(this Vec<τ,α>? vec)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(vec == null)
         return null;
      else
         return vec.Negateß();
   }
   public static Vec<τ,α> Negateß<τ,α>(this Vec<τ,α> vec)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() =>
   ...
   public static Vec<τ,α>? MulInto<τ,α>(this Vec<τ,α>? vec, τ scal)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   internal static Vec<τ,α> MulIntoß<τ,α>(this Vec<τ,α> vec, τ scal)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   public static Vec<τ,α>? MulTop<τ,α>(this Vec<τ,α>? vec, τ scal)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(vec == null || scal.Equals(NonNullable<τ,α>.O.Zero()))
         return null;
      else
   ...
   internal static Vec<τ,α> MulTopß<τ,α>(this Vec<τ,α> vec, τ scal)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   public static Vec<τ,α>? MulSub<τ,α>(this Vec<τ,α>? vec, τ scal, Tnr<τ,α> sup, int inx)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(vec == null || scal.Equals(NonNullable<τ,α>.O.Zero()))
         return null;
      else
   ...
   internal static Vec<τ,α> MulSubß<τ,α>(this Vec<τ,α> vec, τ scal, Tnr<τ,α> sup, int inx)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   public static τ NormSqr<τ,α>(this Vec<τ,α>? vec)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(vec == null)
   ...
   internal static τ NormSqrß<τ,α>(this Vec<τ,α> vec)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   public static Tnr<τ,α>? TnrProdTop<τ,α>(this Vec<τ,α>? v1, Tnr<τ,α>? t2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(v1 == null || t2 == null)
         return null;
      return v1.TnrProdTopß(t2);
   }

   internal static Tnr<τ,α> TnrProdTopß<τ,α>(this Vec<τ,α> v1, Tnr<τ,α> t2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(t2.Rank > 1) {
   ...
   public static Tnr<τ,α>? TnrProdTop<τ,α>(this Vec<τ,α>? v1, Vec<τ,α>? v2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(v1 == null || v2 == null)
         return null;
      return v1.TnrProdTopß(v2);
   }
   ...
   internal static Tnr<τ,α> TnrProdTopß<τ,α>(this Vec<τ,α> v1, Vec<τ,α> v2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   public static Tnr<τ,α>? ContractTopPart2<τ,α>(this Vec<τ,α> v1, Tnr<τ,α> t2, int rankInx2, List<int> strc, int conDim)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   public static Tnr<τ,α>? ContractTop<τ,α>(this Vec<τ,α> v1, Tnr<τ,α> t2, int slot2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      (List<int> strc, _, int rankInx2, int conDim) = v1.ContractTopPart1(t2, 1, slot2);
      return ContractTopPart2(v1, t2, rankInx2, strc, conDim);
   }

   public static τ ContractTop<τ,α>(this Vec<τ,α>? v1, Vec<τ,α>? v2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(v1 == null || v2 == null)
         return NonNullable<τ,α>.O.Zero();
      else
   ...
   public static τ ContractTopß<τ,α>(this Vec<τ,α> v1, Vec<τ,α> v2)  where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      τ res = NonNullable<τ,α>.O.Zero();
   ...
   public static bool Equals<τ,α>(this Vec<τ,α>? v1, Vec<τ,α>? v2) where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
   ...
   public static bool Equals<τ,α>(this Vec<τ,α>? v1, Vec<τ,α>? v2, τ eps) where τ : IEquatable<τ>, IComparable<τ>  where α : IAlgebra<τ>, new() {
      if(v1 == null) {                                                            // If both are null, return true. If only one of them is null, return false.
         if(v2 == null)
            return true;
         else
