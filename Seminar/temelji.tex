...
\begin{equation}
	\hspace{17mm}
	\boxed{
		\vphantom{\bigg(} \ I\big[\mathbf{w(x)}\big] \mkern2mu = \int_{\Omega} F\big(\mathbf{w(x)}\big) \, \ud \Omega \ 
	}
...
\begin{equation}
	\int_{\Omega} \mathbf{R\big(w(x)\big)}^\mathsf{\mkern-1mu T} \mkern-4.5mu \cdot \mkern-1mu \mathbf{v(x)} \ \ud \Omega \, = \, 0 \ .
...
\begin{equation}
	...
	\, = \mkern5mu
	2 \mkern1mu (\mathbsf{A} \! \cdot \! \mathbf{\widetilde{w}} - \mathbf{f})^\mathsf{T} \mkern-2mu \cdot \mathbsf{A}
\end{equation}
...
\begin{equation}
	...
	= \mkern5mu
	\lim_{\varepsilon \rightarrow 0} \, \Big(2 \mkern1mu \big(\mathbsf{A} \! \cdot \! (\mathbf{u} \mkern-2mu + \mkern-2mu \varepsilon \mathbf{v}) - \mathbf{f}\big)^\mathsf{\mkern-2mu T} \mkern-3mu \cdot \mathbsf{A}\Big)
	\, = \mkern5mu
	2 \mkern1mu (\mathbsf{A} \! \cdot \! \mathbf{u} - \mathbf{f})^\mathsf{T} \mkern-2mu \cdot \mathbsf{A} \ .
\end{equation}
