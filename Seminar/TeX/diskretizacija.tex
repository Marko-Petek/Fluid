...
\begin{equation}
      ...
      \left(v^{\mkern 2mu \substack{\varepsilon \\[-0.5mm] \alpha \\[-0.2mm]}}_{\triangleright \mkern5mu k} \mkern2mu \psi_{\varepsilon \alpha}\right)}
   {
      ...
      -
      f^{\substack{\mkern2mu \varepsilon \\[-0.4mm] \gamma} \mkern2mu h} \mkern1mu \psi_{\varepsilon \gamma}}
\end{equation}
...
\begin{equation*}
      ...
      v^{\mkern 2mu \substack{\varepsilon \\[-0.5mm] \alpha \\[-0.2mm]}}_{\triangleright \mkern5mu k} \mkern2mu \psi_{\varepsilon \alpha p} \mkern4mu}
   {
      ...
      -
      f^{\substack{\mkern2mu \varepsilon \\[-0.4mm] \gamma} \mkern2mu h} \mkern1mu \psi_\gamma }
\end{equation*}
Preuredimo:
\begin{equation*}
   \sum^n_\varepsilon
   v^{\mkern 2mu \substack{\varepsilon \\[-0.5mm] \alpha \\[-0.2mm]}}_{\triangleright \mkern5mu k} \mkern2mu A^{bp}_{\mkern14mu jk}
   \braket{
      \psi_{ \varepsilon \beta 0}
      \psi_{\varepsilon \alpha p} }
   {
      \mkern2mu A^{\substack{\mkern2mu \varepsilon \\[-0.4mm] \gamma} \mkern2mu qhl} \psi_{\varepsilon \gamma 0} \mkern4mu u^{\substack{\mkern2mu \varepsilon \\[0.2mm] \delta} \mkern2mu l}_\triangleright \psi_{\varepsilon \delta q}
      +
      A^{\substack{\mkern2mu \varepsilon \\[-0.4mm] \gamma} \mkern2mu qhl} \psi_{\varepsilon \gamma 0} \mkern4mu u^{\substack{\mkern2mu \varepsilon \\[0.2mm] \delta} \mkern2mu l}_\triangleleft \psi_{\varepsilon \delta q}
      -
