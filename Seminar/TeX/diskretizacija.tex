...
\begin{equation}
   \braket{
      \qty(A^{b p}_{\mkern14mu hk} \mkern1mu \Psi_b \frac{\pd}{\pd x_p} ) \mkern-2mu
      \qty(v^{\mkern1mu i}_{\triangleright \mkern1mu k} \mkern1mu \Psi_i )}
   {
      \qty(A^{c q h l} \mkern1mu \Psi_c \frac{\pd}{\pd x_q} ) \mkern-4mu
      \qty(u^{j l}_\triangleright \mkern1mu \Psi_j + u^{j l}_\triangleleft \mkern1mu \Psi_j )
      -
...
\begin{equation}
   \sum^n_{\varepsilon}
   \braket{
      \qty(A^{\substack{\mkern2mu \varepsilon \\[0.15mm] \beta} \mkern2mu p}_{\mkern19mu hk} \mkern2mu \psi_{ \varepsilon \beta} \frac{\pd}{\pd x_p} ) \mkern-4mu
      \qty(v^{\mkern 2mu \substack{\varepsilon \\[-0.5mm] \alpha \\[-0.2mm]}}_{\triangleright \mkern5mu k} \mkern2mu \psi_{\varepsilon \alpha} )}
   {
      \qty(A^{\substack{\mkern2mu \varepsilon \\[-0.4mm] \gamma} \mkern2mu qhl} \mkern2mu \psi_{\varepsilon \gamma} \frac{\pd}{\pd x_q} ) \mkern-4mu
      \qty(u^{\substack{\mkern2mu \varepsilon \\[0.2mm] \delta} \mkern2mu l}_\triangleright \psi_{\varepsilon \delta} + u^{\substack{\mkern2mu \varepsilon \\[0.2mm] \delta} \mkern2mu l}_\triangleleft \psi_{\varepsilon \delta} )
      -
...
\begin{equation*}
   \sum^n_\varepsilon
   \braket{
      \qty( A^{\substack{\mkern2mu \varepsilon \\[0.15mm] \beta} \mkern2mu p}_{\mkern19mu hk} \mkern2mu \psi_{ \varepsilon \beta 0} ) \mkern-2mu
      v^{\mkern 2mu \substack{\varepsilon \\[-0.5mm] \alpha \\[-0.2mm]}}_{\triangleright \mkern5mu k} \mkern2mu \psi_{\varepsilon \alpha p} \mkern4mu}
   {
      \mkern2mu \qty( A^{\substack{\mkern2mu \varepsilon \\[-0.4mm] \gamma} \mkern2mu qhl} \mkern2mu \psi_{\varepsilon \gamma 0} ) \mkern-4mu 
      \qty( u^{\substack{\mkern2mu \varepsilon \\[0.2mm] \delta} \mkern2mu l}_\triangleright \psi_{\varepsilon \delta q} + u^{\substack{\mkern2mu \varepsilon \\[0.2mm] \delta} \mkern2mu l}_\triangleleft \psi_{\varepsilon \delta q} )
      -
...
\begin{equation*}
   \sum^n_\varepsilon   v^{\mkern 2mu \substack{\varepsilon \\[-0.5mm] \alpha \\[-0.2mm]}}_{\triangleright \mkern5mu k} \qty(
   \expval{ \psi_{ \varepsilon \beta 0} \mkern1mu    \psi_{\varepsilon \alpha p} \mkern1mu    \psi_{\varepsilon \gamma 0} \mkern1mu    \psi_{\varepsilon \delta q} }
   ...
   -
   \expval{ \psi_{ \varepsilon \beta 0} \mkern1mu    \psi_{\varepsilon \alpha p} \mkern1mu    \psi_{\varepsilon \gamma 0} }    A^{\substack{\mkern2mu \varepsilon \\[0.15mm] \beta} \mkern2mu p}_{\mkern19mu hk}    f^{\substack{\mkern2mu \varepsilon \\[-0.4mm] \gamma} \mkern2mu h}_{\bowtie} )
\end{equation*}
Definiramo tenzorja $\mathbsf{S}$ in $\mathbsf{T}$:
\begin{equation}
   S_{\varepsilon \beta \alpha p \gamma \delta q} = \expval{ \psi_{ \varepsilon \beta 0} \mkern1mu    \psi_{\varepsilon \alpha p} \mkern1mu    \psi_{\varepsilon \gamma 0} \mkern1mu    \psi_{\varepsilon \delta q} } \ ,
\end{equation}
\begin{equation}
   T_{\varepsilon \beta \alpha p \gamma} = \expval{ \psi_{ \varepsilon \beta 0} \mkern1mu    \psi_{\varepsilon \alpha p} \mkern1mu    \psi_{\varepsilon \gamma 0} } \ .
\end{equation}
Tako imamo:
\begin{equation}
   \sum^n_\varepsilon v^{\mkern 2mu \substack{\varepsilon \\[-0.5mm] \alpha \\[-0.2mm]}}_{\triangleright \mkern5mu k} \qty(
...
\begin{equation}
   ...
   \qty(
   S_{\varepsilon \beta \alpha p \gamma \delta q} \mkern2mu
   A^{\substack{\mkern2mu \varepsilon \\[0.15mm] \beta} \mkern2mu p}_{\mkern19mu hk}    A^{\substack{\mkern2mu \varepsilon \\[-0.4mm] \gamma} \mkern2mu qhl} \mkern1mu     u^{\substack{\mkern2mu \varepsilon \\[0.2mm] \delta} \mkern2mu l}_\triangleright ) \mkern3mu }
\end{equation}
\vspace{1mm}
\begin{equation}
   ...
   A^{\substack{\mkern2mu \varepsilon \\[0.15mm] \beta} \mkern2mu p}_{\mkern19mu hk}    f^{\substack{\mkern2mu \varepsilon \\[-0.4mm] \gamma} \mkern2mu h}_{\bowtie}
   -
   S_{\varepsilon \beta \alpha p \gamma \delta q}    A^{\substack{\mkern2mu \varepsilon \\[0.15mm] \beta} \mkern2mu p}_{\mkern19mu hk}    A^{\substack{\mkern2mu \varepsilon \\[-0.4mm] \gamma} \mkern2mu qhl}    u^{\substack{\mkern2mu \varepsilon \\[0.2mm] \delta} \mkern2mu l}_\triangleleft ) \mkern3mu }
\end{equation}
\begin{equation*}
...
\begin{equation}
   S_{\beta \alpha p \gamma \delta q} = \expval{ \phi^{\phantom{\beta}0}_\beta \mkern1mu ( \mathfrak{J}_{pr} \phi^{\phantom{\alpha}r}_\alpha ) \mkern1mu \phi^{\phantom{\gamma}0}_\gamma ( \mathfrak{J}_{qs}  \phi^{\phantom{\delta}s}_\delta ) \mkern2mu |\mkern-2mu \det \mathbsf{J}| }_{\bm{\chi}}
\end{equation}
\begin{equation}
   T_{\beta \alpha p \delta} = \expval{ \phi^{\phantom{\beta}0}_\beta\mkern1mu ( \mathfrak{J}_{pr} \phi^{\phantom{\alpha}r}_\alpha ) \phi^{\phantom{\delta}0}_\delta \mkern2mu |\mkern-2mu \det \mathbsf{J}| }_{\bm{\chi}} \ .
\end{equation}
Zapis, primeren za implementacijo:
\begin{equation}
   S_{\varepsilon \beta \alpha p \gamma \delta q}
   =
   \expval{ \phi^{\phantom{\beta}0}_\beta \mkern1mu
   (\mathfrak{J}_{\varepsilon  pr}    \phi^{\phantom{\alpha}r}_\alpha ) \mkern1mu
   \phi^{\phantom{\gamma}0}_\gamma
   (\mathfrak{J}_{\varepsilon qs}    \phi^{\phantom{\delta}s}_\delta ) \mkern2mu
   |\mathfrak{J}_{\varepsilon 00}| }_{\bm{\chi}}
\end{equation}
\begin{equation}
   T_{\varepsilon \beta \alpha p \delta}
   =
   \expval{ \phi^{\phantom{\beta}0}_\beta
   \mkern1mu
