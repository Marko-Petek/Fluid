...
\begin{equation}
   \sum_i v^a_{\phantom{a}k} A^{b\phantom{p}jk}_{\phantom{j}p} \left( \left\langle \frac{1}{\widetilde{J}^0_{\phantom{0}0}} \phi^{\phantom{b}0}_b \phi^{\phantom{c}0}_c \mkern2mu \widetilde{J}^p_{\phantom{p}r}  \phi^{\phantom{a}r}_a \mkern1mu \widetilde{J}^q_{\phantom{q}s}  \phi^{\phantom{d}s}_d \right\rangle_{\mkern-5mu\bm{\chi}} \mkern-2mu A^{c\phantom{qj}l}_{\phantom{c}qj} u^d_{\phantom{d}l} \mkern1mu - \mkern1mu \left\langle\phi^{\phantom{b}0}_b \phi^{\phantom{d}0}_d \mkern2mu \widetilde{J}^p_{\phantom{p}r}  \phi^{\phantom{a}r}_a \right\rangle_{\mkern-3mu\bm{\chi}} \mkern-1mu f^d_{\phantom{d}j} \mkern2mu \right) = 0
\end{equation}
