...
\end{equation}
Po elementih $(a,b,c,d) \in [1,12]$, kjer je $n$ število elementov.
\begin{equation}
   \sum^n_{i} \bra{
...
\begin{IEEEeqnarray*}{ccc}
   \alpha, \beta, \gamma, \delta & \ \rightarrow \ & \text{vozlišča znotraj elementa od 1 do 12}, \\
   \varepsilon & \ \rightarrow \ & \text{indeks elementa od 1 do } n, \\
   p, q, r, s & \ \rightarrow \ & \text{indeks parcialnega odvoda od 0 do 2}
\end{IEEEeqnarray*}
