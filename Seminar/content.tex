...
\begin{IEEEeqnarray}{rl}
	...
	\frac{\pd p}{\pd x} + \frac{\pd \omega}{\pd y} &= f_x \ ,
\end{IEEEeqnarray}
\end{minipage}
\begin{minipage}{5.3cm}
\begin{IEEEeqnarray}{rl}
	\frac{\pd p}{\pd y} - \frac{\pd \omega}{\pd x} &= f_y \ , \\[0.3cm]
...
\end{equation}
Komaj tukaj se začne formulacija Galerkinove različice. Na izraz v oklepaju gledamo v kontekstu \texttt{RRFEM} kot na funkcijo potenciala povezanega s sistemom \texttt{PDE}. Namesto omenjenega izraza v oklepaju vstavimo vektor ostanka \eqref{eq:residual}:
\begin{equation}
