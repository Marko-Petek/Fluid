...
\begin{IEEEeqnarray}{rl}
	...
	\label{eq:StokesXMom}
	\\[0.3cm]
	\gamma \frac{\pd p}{\pd y} - \delta \frac{\pd \omega}{\pd x} &= f_y \ ,
\end{IEEEeqnarray}
\end{minipage}
\begin{minipage}{0.3\textwidth}
\begin{IEEEeqnarray}{rl}
