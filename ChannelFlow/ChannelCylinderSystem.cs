...
namespace Fluid.ChannelFlow {
   ...
   public class ChannelCylinderSystem {
      ...
      public SparseRow SolVec { get; protected set; }
      ...
      public ChannelCylinderSystem(double peakInletVelocity, double dt, double viscosity) {         TB.Reporter.Write($"Creating ChannelFlow with peak inlet velocity {peakInletVelocity} and viscosity {viscosity}.", Verbose);
