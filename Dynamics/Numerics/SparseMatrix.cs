...
namespace Fluid.Dynamics.Numerics
{
    ...
    where T : struct, IEquatable<T>
    {
        ...
        public static SparseMatrix<T> operator + (SparseMatrix<T> left, SparseMatrix<T> right) {
            ...
            CheckFieldsEquivalence(left._width, right._width, IntComparer);             // Check that width and height of operands match.
            CheckFieldsEquivalence(left._height, right._height, IntComparer);
        ...
        public static SparseRow<T> operator * (SparseMatrix<T> matrix, SparseRow<T> vector) {
            CheckFieldsEquivalence(matrix._width, vector.GetWidth(), IntComparer);                 // Check that matrix and row can be multiplied.
        ...
        public static SparseRow<T> operator * (SparseRow<T> vector, SparseMatrix<T> matrix) {
            CheckFieldsEquivalence(vector.GetWidth(), matrix._height, IntComparer);
